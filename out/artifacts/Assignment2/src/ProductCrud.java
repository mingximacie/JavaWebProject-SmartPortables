...
public class ProductCrud extends HttpServlet {
    protected void doGet(HttpServletRequest request,
        ...
        String msg = "good";
        String producttype = "", productId = "", productName = "", productManufacturer = "", productCondition = "", ManufacturerRebate = "";
        int inventory = 0;
        ...
        if (action.equals("add")) {
            if (producttype.equals("wearables")) {
             ...
             if (msg.equals("good")) {
                try {
                    msg = MySqlDataStoreUtilities.addproducts(producttype, productId, productName, productPrice, productManufacturer, productCondition, productDiscount,ManufacturerRebate,inventory);
                } catch (Exception e) {
            ...
            if (msg.equals("good"))
            {
                ...
                try
                {
                    msg = MySqlDataStoreUtilities.updateproducts(producttype,productId,productName,productPrice,productManufacturer,productCondition,productDiscount,ManufacturerRebate,inventory);
                }
                catch(Exception e)
                {
