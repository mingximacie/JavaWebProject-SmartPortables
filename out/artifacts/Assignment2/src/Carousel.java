		...
		for (OrderItem oi : utility.getCustomerOrders())
		{
			...
			{	
				...
				*/
				...
				Wearable wearable1 = hm.get(oi.getName());
...
//				{
//
//					VoiceAssistant voiceAssistant = SaxParserDataStore.voice.get(acc.getValue());
//					if (k==0 )
//					{
//
...
//					sb.append("<h3>"+ voiceAssistant.getName()+"</h3>");
//					sb.append("<strong>"+ voiceAssistant.getPrice()+"$</strong><ul>");
