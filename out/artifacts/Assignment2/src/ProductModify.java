    ...
    protected void doGet(HttpServletRequest request,
        ...
        if(action.equals("Addproduct"))
        {
            ...
            pw.print("<form method='get' action='ProductCrud'>"
                    ...
                    + "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='wearables' selected>Wearable</option><option value='phones'>Phone</option><option value='laptops'>Laptop</option><option value='voice'>Voice Assistant</option></select>"
                    + "</td></tr><tr><td>"
                    ...
                    + "</td></tr><tr><td>"
                    + "<h3>Manufacturer Rebate</h3></td><td><select name='ManufacturerRebate'><option value='Yes' selected>Yes</option><option value='No'>No</option>"
                    + "</td></tr><tr><td>"
                    + "<h3>Inventory</h3></td><td><input type='number' step='any' placeholder='please enter numeric data' name='inventory' value='' class='input' required></input>"
                    + "</td></tr><tr><td>"
