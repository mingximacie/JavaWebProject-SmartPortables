...
public class AjaxUtility {
    ...
    public static HashMap<String,Product> getData()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {	Product p = new Product(rs.getString("Id"),rs.getString("productName"),rs.getDouble("productPrice"),rs.getString("productManufacturer"),rs.getString("productCondition"),rs.getString("ProductType"),rs.getDouble("productDiscount"));
    ...
    public static void storeData(HashMap<String,Product> productdata)
    {
        try
        {
            ...
            String insertIntoProductQuery = "INSERT INTO product(productId,productName,retailer,productCondition,productPrice,productType,discount) "
                    + "VALUES (?,?,?,?,?,?,?);";
            for(Map.Entry<String, Product> entry : productdata.entrySet())
            {
                ...
                pst.setString(3,entry.getValue().getRetailer());
                pst.setString(4,entry.getValue().getCondition());
