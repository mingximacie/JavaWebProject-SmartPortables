...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<table  class='gridtable'><tr><td>User ID:</td><td>");
		pw.print(userName);
		pw.print("</td></tr>");
		...
		pw.print("</form>");
		pw.print("<form method='post' action='Pickup'>");
		pw.print("<input type='submit' name='Option' value='Pickup'>") ;
		pw.print("</form>");
		pw.print("<input type='radio' name='Option' value='Home Delivery'>Delivery");
		pw.print("</td></tr>");
