...
public class MySqlDataStoreUtilities {
	...
	public static void Insertproducts() {
		try {
			...
			String insertProductQurey = "INSERT INTO  Productdetails(ProductType,Id,productName,productPrice,productManufacturer,productCondition,productDiscount,ManufacturerRebate,inventory)" +
					"VALUES (?,?,?,?,?,?,?,?,?);";
			...
			for (Map.Entry<String, Phones> entry : SaxParserDataStore.phone.entrySet()) {
				...
				pst.setString(8, phones.getRebate());
				pst.setInt(9, phones.getInventory());
			...
			for (Map.Entry<String, Laptops> entry : SaxParserDataStore.laptop.entrySet()) {
				...
				pst.setString(8, laptops.getRebate());
				pst.setInt(9, laptops.getInventory());
			...
			for (Map.Entry<String, VoiceAssistant> entry : SaxParserDataStore.voice.entrySet()) {
				...
				pst.setString(8, voices.getRebate());
				pst.setInt(9, voices.getInventory());
	...
	public static HashMap<String, Wearable> getWearables() {
		...
		try {
			...
			while (rs.next()) {
				Wearable con = new Wearable(rs.getString("productName"), rs.getDouble("productPrice"), rs.getString("productManufacturer"), rs.getString("productCondition"), rs.getDouble("productDiscount"), rs.getString("ManufacturerRebate"), rs.getInt("inventory"));
	...
	public static HashMap<String, Laptops> getLaptopss() {
		...
		try {
			...
			while (rs.next()) {
				Laptops lap = new Laptops(rs.getString("productName"), rs.getDouble("productPrice"), rs.getString("productManufacturer"), rs.getString("productCondition"), rs.getDouble("productDiscount"), rs.getString("ManufacturerRebate"), rs.getInt("inventory"));
	...
	public static HashMap<String, Phones> getPhoness() {
		...
		try {
			...
			while (rs.next()) {
				Phones phone = new Phones(rs.getString("productName"), rs.getDouble("productPrice"), rs.getString("productManufacturer"), rs.getString("productCondition"), rs.getDouble("productDiscount"), rs.getString("ManufacturerRebate"), rs.getInt("inventory"));
	...
	public static HashMap<String, VoiceAssistant> getVoice() {
		...
		try {
			...
			while (rs.next()) {
				VoiceAssistant voice = new VoiceAssistant(rs.getString("productName"), rs.getDouble("productPrice"), rs.getString("productManufacturer"), rs.getString("productCondition"), rs.getDouble("productDiscount"), rs.getString("ManufacturerRebate"), rs.getInt("inventory"));
	...
	public static HashMap<String, Product> getProduct() {
		...
		try {
			...
			while (rs.next()) {
				Product pro = new Product(rs.getString("productType"), rs.getString("Id"), rs.getString("productName"), rs.getDouble("productPrice"), rs.getString("productManufacturer"), rs.getString("productCondition"), rs.getDouble("productDiscount"), rs.getString("ManufacturerRebate"), rs.getInt("inventory"));
				hm.put(rs.getString("Id"), pro);
	...
	public static HashMap<String, Transactions> getTransaction() {
		HashMap<String, Transactions> hm = new HashMap<String, Transactions>();
		try {
			getConnection();

			String selectOrder = "select * from Transactions";
			PreparedStatement pst = conn.prepareStatement(selectOrder);
			ResultSet rs = pst.executeQuery();

			while (rs.next()) {
				Transactions pro = new Transactions(rs.getInt("orderId"), rs.getDate("purchaseDate"), rs.getString("productId"), rs.getDouble("price"));
				hm.put(rs.getString("orderId"), pro);
	...
	public static String addproducts(String producttype, String productId, String productName, double productPrice, String productManufacturer,
									 String productCondition, double productDiscount, String ManufacturerRebate, int inventory) {
		String msg = "Product is added successfully";
		try {

			getConnection();
			String addProductQurey = "INSERT INTO  Productdetails(ProductType,Id,productName,productPrice,productManufacturer,productCondition,productDiscount,ManufacturerRebate,inventory)" +
					"VALUES (?,?,?,?,?,?,?,?,?);";
			...
			pst.setString(8, ManufacturerRebate);
	...
	public static String updateproducts(String producttype, String productId, String productName, double productPrice, String productManufacturer, String productCondition, double productDiscount
			, String ManufacturerRebate, int inventory) {
		String msg = "Product is updated successfully";
		try {

			getConnection();
			String updateProductQurey = "UPDATE Productdetails SET productName=?,productPrice=?,productManufacturer=?,productCondition=?,productDiscount=?,ManufacturerRebate=?,inventory=? where Id =?";
			...
			pst.setString(6, ManufacturerRebate);
			pst.setInt(7, inventory);
	...
	public static ArrayList<prod> selectInventoryForChart() {
		ArrayList<prod> prod = new ArrayList<>();
		HashMap<String, Product> hm = new HashMap<>();
		try {
			hm = MySqlDataStoreUtilities.getProduct();
			int i=0;
			for (Map.Entry<String, Product> p : hm.entrySet()) {
				prod pro = new prod(p.getValue().getName(), p.getValue().getInventory());
				prod.add(pro);
				i++;
			}
