...
public class LaptopsList extends HttpServlet {
	...
	/* Trending Page Displays all the Tablets and their Information in Phones Speed */
	...
	protected void doGet(HttpServletRequest request,
		...
		All the laptop and laptops information are dispalyed in the Content Section
		...
		for (Map.Entry<String, Laptops> entry : hm.entrySet()) {
			...
			pw.print("<li><em>"+ Laptops.getDescription()+"</em></li>");
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+Laptops.getName()+"'>"+
					"<input type='hidden' name='type' value='laptop'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='price' value='"+Laptops.getPrice()+"'>"+
					"<input type='hidden' name='access' value=''>"+
				    "<input type='submit' value='WriteReview' class='btnreview'></form></li>");
			pw.print("<li><form method='post' action='ViewReview'>"+"<input type='hidden' name='name' value='"+Laptops.getName()+"'>"+
					"<input type='hidden' name='type' value='laptop'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
