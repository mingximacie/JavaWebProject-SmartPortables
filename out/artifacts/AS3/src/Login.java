...
public class Login extends HttpServlet {
	...
	/*  Login Screen is Displayed, Registered User specifies credentials and logins into the Phones Speed Application. */
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Login'>"
				...
				"<option value='retailer'>Salesman</option></select>"
				+ "</td></tr><tr><td></td><td>"
